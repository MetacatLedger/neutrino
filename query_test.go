...
import (
	...
	"github.com/classzz/neutrino/cache"
	"github.com/classzz/neutrino/cache/lru"
	"github.com/classzz/neutrino/filterdb"
...
// a slice of them.
//
// NOTE: copied from gcash/bchd/database/ffldb/interface_test.go
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) (
	...
	blocks := make([]*czzutil.Block, 0, 256)
	genesis := czzutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
