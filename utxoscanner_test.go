...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*czzutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, czzutil.NewBlock(&Block100000))
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, czzutil.NewBlock(&Block99999))
...
// The following is taken from the gcash/czzutil project.
